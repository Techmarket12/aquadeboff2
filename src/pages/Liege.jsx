...
const AiDiagnosticModal = ({ isOpen, onClose }) => {
  ...
  const handleAnalyze = async () => {
    ...
    const apiKey = '';
    const prompt = `Act as an expert plumber in Liège, Belgium. Analyze this customer issue: "${description}".
    Respond in JSON format ONLY.
    {
      ...
      "estimated_intervention_time": "30-45 min (Liège)"
    }`;
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden border border-slate-200">
        <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-6 flex justify-between items-center text-white">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold">Diagnostic Express Liège</h3>
          </div>
          ...
          {!result ? (
            <>
              <p className="text-slate-600 mb-4 font-medium">
                Habitant de Liège ou environs ? Décrivez votre problème de plomberie ou débouchage.
              </p>
              <textarea
                ...
                placeholder="Exemple : J'habite à Angleur et mon évier est bouché..."
                value={description}
            ...
            <div className="space-y-6">
              ...
              >
                <Phone className="w-6 h-6" /> Appeler l'équipe Liège
              </a>
            </div>
          )}
        </div>
...
export default function ZoneLiegePage() {
  ...
  return (
    <div className="font-sans text-slate-800 antialiased bg-white selection:bg-orange-500 selection:text-white">
      ...
      <div className="bg-red-600 text-white text-center py-2 px-4 text-xs md:text-sm font-bold">
        Intervention prioritaire sur Liège Centre, Outremeuse, Guillemins et alentours.
      </div>
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            ...
            <span className="flex items-center gap-1 text-orange-400 font-bold">
              <Star className="w-3 h-3 fill-current" /> 4.9/5 (Clients Liégeois)
            </span>
          </div>
        </div>
      </div>
      ...
      <main>
        <section className="relative pt-16 pb-24 bg-slate-900 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center lg:text-left">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 px-4 py-2 rounded-full text-sm font-bold mb-6">
              <MapPin className="w-4 h-4" /> Intervention rapide à Liège
            </span>
            <h1 className="text-4xl lg:text-6xl font-black text-white mb-6">
              Plombier & Déboucheur à <span className="text-orange-500">Liège</span>
            </h1>
            <p className="text-xl text-slate-300 max-w-3xl lg:max-w-2xl">
              Besoin d'un plombier en urgence sur <strong>Liège et sa province</strong> ? Aqua&Deb est votre spécialiste local
              pour le débouchage de canalisations, la réparation de fuites et l'installation sanitaire.
              <strong>Intervention en moins d'une heure</strong> sur Angleur, Grivegnée, Herstal et environs.
            </p>
            ...
            <div className="grid lg:grid-cols-3 gap-6 mt-10 max-w-3xl lg:max-w-4xl">
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                <div className="flex items-center gap-3 text-white font-black">
                  <Clock className="w-5 h-5 text-orange-300" /> Rapidité Liège
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-10">
              ...
              >
                <Phone className="w-6 h-6" /> Plombier Liège
              </a>
              <button
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-black text-slate-900 mb-6 text-center">
              Vos services à <span className="text-blue-600">Liège</span>
            </h2>
            <p className="text-slate-600 max-w-4xl mx-auto text-center text-lg leading-relaxed">
              Que vous soyez un particulier à Rocourt, un commerçant dans le Carré de Liège ou une entreprise
              dans le zoning des Hauts-Sarts, nous avons la solution.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {['Débouchage WC Liège', 'Fuite d\'eau Seraing', 'Boiler Ans', 'égouttage Herstal'].map((item, i) => (
            ...
            <div className="mt-12 grid lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-2xl border border-slate-100 p-8 shadow-sm">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  ...
                  Nous intervenons souvent dans les vieilles maisons de maître liégeoises pour la rénovation
              ...
              <div className="bg-white rounded-2xl border border-slate-100 p-8 shadow-sm">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  ...
                  Service rapide pour les restaurants et kots étudiants très présents à Liège.
                </p>
                 <ul className="grid grid-cols-2 gap-2 text-sm text-slate-600">
          ...
          <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-black text-slate-900 mb-6">
                Zones desservies autour de <span className="text-red-600">Liège</span>
              </h2>
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                Notre équipe couvre l'ensemble du Grand Liège et les communes avoisinantes.
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm text-slate-600">
                  <span>Liège Centre</span>
                  <span>Outremeuse</span>
                  <span>Angleur</span>
                  <span>Grivegnée</span>
                  <span>Herstal</span>
                  <span>Seraing</span>
            ...
            <div className="relative flex justify-center">
              <img
                ...
                alt="Travaux construction Liège"
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-black text-slate-900 mb-4">
              L'eau à Liège : <span className="text-blue-600">Calcaire ?</span>
            </h2>
            <p className="text-slate-600 mb-12 max-w-3xl mx-auto">
              L'eau de la région liégeoise est moyennement dure. Le calcaire peut endommager vos boilers et robinets.
            </p>
            <div className="grid md:grid-cols-3 gap-8 text-left">
               ...
               <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                 ...
                 <p className="text-sm text-slate-600">
                   Dans le vieux Liège, attention aux canalisations en plomb ou grès qui peuvent fuir. Nous les remplaçons.
                 </p>
               </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-slate-900 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-black mb-6">Tarifs Plombier Liège</h2>
            <p className="text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
              Transparence totale. Pas de frais de déplacement cachés pour la zone Liège.
            </p>
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {["Déplacement Liège inclus", "Tarif horaire clair", "Devis gratuit sur place"].map((t, i) => (
        ...
        <section className="py-20 bg-orange-600 text-white text-center">
          <h2 className="text-3xl font-black mb-4">Urgence Plomberie à Liège ?</h2>
